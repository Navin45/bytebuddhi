...
class ProjectCreateRequest(BaseModel):
    ...
    repository_url: str | None = Field(default=None, max_length=500, description="Git repository URL")
    local_path: str | None = Field(default=None, max_length=500, description="Local filesystem path")
    language: str | None = Field(default=None, max_length=50, description="Primary programming language")
    framework: str | None = Field(default=None, max_length=100, description="Framework or tech stack")


class ProjectUpdateRequest(BaseModel):
    """Request schema for updating an existing project."""

    name: str | None = Field(default=None, min_length=1, max_length=200, description="Project name")
    description: str | None = Field(default=None, max_length=1000, description="Project description")
    repository_url: str | None = Field(default=None, max_length=500, description="Git repository URL")
    local_path: str | None = Field(default=None, max_length=500, description="Local filesystem path")
    language: str | None = Field(default=None, max_length=50, description="Primary programming language")
    framework: str | None = Field(default=None, max_length=100, description="Framework or tech stack")
    is_active: bool | None = Field(default=None, description="Whether project is active")
...
class ProjectResponse(TimestampMixin):
    ...
    framework: str | None = Field(default=None, description="Framework or tech stack")
    last_indexed_at: datetime | None = Field(default=None, description="Last indexing timestamp")
