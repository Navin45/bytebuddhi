...
class AnthropicProvider(LLMProvider):
    ...
    async def generate(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            return str(response.content) if not isinstance(response.content, str) else response.content
        ...
        **kwargs: Any,
        ...
        try:
            ...
            async for chunk in self.chat_model.astream(lc_messages):
                if chunk.content:
                    yield str(chunk.content) if not isinstance(chunk.content, str) else chunk.content
        except Exception as e:
    ...
    async def generate_embedding(self, text: str) -> list[float]:
        ...
        """
        raise NotImplementedError("Anthropic does not provide embedding models. Use OpenAI provider for embeddings.")
